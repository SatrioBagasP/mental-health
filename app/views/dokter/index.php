            ...
            <div class="dokter-card-wrapper">
                ...
                <div class="dokter-card-desc">
                    <div class="dokter-name">
                        ...
                        <span class="bg-indigo-100 text-indigo-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-indigo-900 dark:text-indigo-300 marginleft-10"> <?php echo $item['nama_kategori']; ?></span>
                    </div>
    ...
    <div class="page">
        <ul>
            ...
            <?php if ($data['currentPage'] > 1) : ?>
                <li>
                    <a href="<?= BASEURL; ?>/dokter/<?php echo $data['currentPage'] - 1; ?>">
                        Previous</a>
                </li>
            <?php endif; ?>
